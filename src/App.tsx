...
<div key={index} className="relative overflow-hidden rounded-xl bg-white border-2 border-gray-200 shadow-lg p-4 flex items-center">
                <table className="w-full text-center border-collapse">
                  <thead>
                    <tr>
                      <th className="border border-gray-300 p-2 text-base">WBGTによる<br/>温度基準域</th>
                      <th className="border border-gray-300 p-2 text-base">注意すべき<br/>生活活動の目安</th>
                      <th className="border border-gray-300 p-2 text-base">注意事項</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                     <td className="border border-gray-300 p-2 bg-red-600 text-white font-bold text-base w-40">危険<br/>31℃以上</td>
                      <td className="border border-gray-300 p-2 text-sm">すべての生活活動で<br/>おこる危険性</td>
                      <td className="border border-gray-300 p-2 text-sm">高齢者においては安静状態でも発生する危険性が大きい。外出はなるべく避け、涼しい室内に移動する。</td>
                    </tr>
                    <tr>
                      <td className="border border-gray-300 p-2 bg-orange-500 text-white font-bold text-base w-40">厳重警戒<br/>28℃以上31℃未満</td>
                      <td className="border border-gray-300 p-2 text-sm">外出時は炎天下を避け、室内では室温の上昇に注意する。</td>
                      <td className="border border-gray-300 p-2 text-sm">外出時は炎天下を避け、室内では室温の上昇に注意する。</td>
                    </tr>
                    <tr>
                      <td className="border border-gray-300 p-2 bg-yellow-400 font-bold text-base w-40">警戒<br/>25℃以上28℃未満</td>
                      <td className="border border-gray-300 p-2 text-sm">中等度以上の生活活動で<br/>おこる危険性</td>
                      <td className="border border-gray-300 p-2 text-sm">運動や激しい作業をする際は定期的に充分に休息を取り入れる。</td>
                    </tr>
                    <tr>
                      <td className="border border-gray-300 p-2 bg-yellow-100 font-bold text-base w-40">注意<br/>25℃未満</td>
                      <td className="border border-gray-300 p-2 text-sm">強い生活活動でおこる危険性</td>
                      <td className="border border-gray-300 p-2 text-sm">一般的に危険性は少ないが激しい運動や重労働には発生する可能性がある。</td>
                    </tr>
                  </tbody>
                </table>
              </div>
